...
public class TC004_APSFCBasicDetails extends PreAndPost{	

	@BeforeTest
	public void setValues() {
		testCaseName = "TC004_APSFCBasicDetails";
		testDescription = "APSFC age validation";
		nodes = "APSFC";
		authors = "Gayatri";
		category = "Sanity";
		dataSheetName = "APSFC4";
		sheetName = "APSFCSHEET4";
	}
	...
	public void basicDetails(
		...
		.rowNumC4()		
		.ageValidatorMax(rowNumC4, maxDob, "APSFC4", "APSFCSHEET4")
		.ageValidatorMin(rowNumC4, minDob, "APSFC4", "APSFCSHEET4")
		.ageValidatorAsOnDate(rowNumC4,dateAsOnDate2, "APSFC4", "APSFCSHEET4")
