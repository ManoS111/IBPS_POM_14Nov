...
public class TC001_APSFCBasicDetails extends PreAndPost{	

	@BeforeTest
	public void setValues() {
		testCaseName = "TC001_APSFCBasicDetails";
		testDescription = "APSFC age validation";
		nodes = "APSFC";
		authors = "Gayatri";
		category = "Sanity";
		dataSheetName = "APSFC1";
		sheetName = "APSFCSHEET1";
	}
	...
	public void basicDetails(
		...
		.rowNumC1()  
		.ageValidatorMax(rowNumC1, maxDob, "APSFC1", "APSFCSHEET1")
		.ageValidatorMin(rowNumC1, minDob, "APSFC1", "APSFCSHEET1")
		.ageValidatorAsOnDate(rowNumC1,dateAsOnDate2, "APSFC1", "APSFCSHEET1")
