...
public class TC002_APSFCBasicDetails extends PreAndPost{	

	@BeforeTest
	public void setValues() {
		testCaseName = "TC002_APSFCBasicDetails";
		testDescription = "APSFC age validation";
		nodes = "APSFC";
		authors = "Gayatri";
		category = "Sanity";
		dataSheetName = "APSFC2";
		sheetName = "APSFCSHEET2";
	}
	...
	public void basicDetails(
		...
		.rowNumC2()		
		.ageValidatorMax(rowNumC2, maxDob, "APSFC2", "APSFCSHEET2")
		.ageValidatorMin(rowNumC2, minDob, "APSFC2", "APSFCSHEET2")
		.ageValidatorAsOnDate(rowNumC2,dateAsOnDate2, "APSFC2", "APSFCSHEET2")
