...
public class TC005_ZPBasicDetails extends PreAndPost{	

	@BeforeTest
	public void setValues() {
		testCaseName = "TC005_ZPBasicDetails";
	...
	public void basicDetails(
		...
		.rowNumC5()		
		.ageValidatorMax(rowNumC5, maxDob, "ZP5", "ZPST5")
		.ageValidatorMin(rowNumC5, minDob, "ZP5", "ZPST5")
		.ageValidatorAsOnDate(rowNumC5,dateAsOnDate2, "ZP5", "ZPST5")
