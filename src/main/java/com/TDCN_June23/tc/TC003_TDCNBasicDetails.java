...
public class TC003_TDCNBasicDetails extends PreAndPost{	

	@BeforeTest
	public void setValues() {
		testCaseName = "TC003_TDCNBasicDetails";
	...
	public void basicDetails(
		...
		.rowNumC3()		
		.ageValidatorMax(rowNumC3, maxDob, "TDCN3", "TDCNST3")
		.ageValidatorMin(rowNumC3, minDob, "TDCN3", "TDCNST3")
		.ageValidatorAsOnDate(rowNumC3,dateAsOnDate2, "TDCN3", "TDCNST3")
		.clickDetailsButton();
