...
public class TC002_TDCNBasicDetails extends PreAndPost{	

	@BeforeTest
	public void setValues() {
		testCaseName = "TC002_TDCNBasicDetails";
	...
	public void basicDetails(
		...
		.rowNumC2()		
		.ageValidatorMax(rowNumC2, maxDob, "TDCN2", "TDCNST2")
		.ageValidatorMin(rowNumC2, minDob, "TDCN2", "TDCNST2")
		.ageValidatorAsOnDate(rowNumC2,dateAsOnDate2, "TDCN2", "TDCNST2")
		.clickDetailsButton();
