...
public class TC005_TDCNBasicDetails extends PreAndPost{	

	@BeforeTest
	public void setValues() {
		testCaseName = "TC005_TDCNBasicDetails";
	...
	public void basicDetails(
		...
		.rowNumC5()		
		.ageValidatorMax(rowNumC5, maxDob, "TDCN5", "TDCNST5")
		.ageValidatorMin(rowNumC5, minDob, "TDCN5", "TDCNST5")
		.ageValidatorAsOnDate(rowNumC5,dateAsOnDate2, "TDCN5", "TDCNST5")
		.clickDetailsButton();
