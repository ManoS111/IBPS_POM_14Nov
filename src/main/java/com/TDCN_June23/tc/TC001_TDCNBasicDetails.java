...
public class TC001_TDCNBasicDetails extends PreAndPost{	

	@BeforeTest
	public void setValues() {
		testCaseName = "TC001_TDCNBasicDetails";
	...
	public void basicDetails(
		...
		.rowNumC1()  
		.ageValidatorMax(rowNumC1, maxDob, "TDCN1", "TDCNST1")
		.ageValidatorMin(rowNumC1, minDob, "TDCN1", "TDCNST1")
		.ageValidatorAsOnDate(rowNumC1,dateAsOnDate2, "TDCN1", "TDCNST1")
		.clickDetailsButton();
	}
}
