...
public class TC002_IDBIBasicDetails extends PreAndPost{	

	@BeforeTest
	public void setValues() {
		testCaseName = "TC002_IDBIBasicDetails";
		testDescription = "IDBI age validation";
		nodes = "IDBI";
		authors = "Gayatri";
		category = "Sanity";
		dataSheetName = "IDBI_2";
		sheetName = "IDBIUSERS2";
	}
	...
	public void basicDetails(String snum,String Desc,String Post,String Area,String Category,String PWD,
		...
		.rowNumC2()		
		.ageValidatorMax(rowNumC2, maxDob, "IDBI_2", "IDBIUSERS2")
		.ageValidatorMin(rowNumC2, minDob, "IDBI_2", "IDBIUSERS2")
		.ageValidatorAsOnDate(rowNumC2,dateAsOnDate2, "IDBI_2", "IDBIUSERS2")
