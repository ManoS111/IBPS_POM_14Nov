...
public class TC003_RBIBasicDetails extends PreAndPost{	

	@BeforeTest
	public void setValues() {
		testCaseName = "TC003_RBIBasicDetails";
	...
	public void basicDetails(String Snum,String Desc,String Area,String Post,String Category,String PWD,String PWDTYPE,String Blindness,String HardOfHearing,
		...
		.rowNumC3()		
		.ageValidatorMax(rowNumC3, maxDob, "RBI_3", "RBIUSERS3")
		.ageValidatorMin(rowNumC3, minDob, "RBI_3", "RBIUSERS3")
		.ageValidatorAsOnDate(rowNumC3,dateAsOnDate2, "RBI_3", "RBIUSERS3")
