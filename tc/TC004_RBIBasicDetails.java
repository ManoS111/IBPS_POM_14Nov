...
public class TC004_RBIBasicDetails extends PreAndPost{	

	@BeforeTest
	public void setValues() {
		testCaseName = "TC004_RBIBasicDetails";
	...
	public void basicDetails(String Snum,String Desc,String Area,String Post,String Category,String PWD,String PWDTYPE,String Blindness,String HardOfHearing,
		...
		.rowNumC4()		
		.ageValidatorMax(rowNumC4, maxDob, "RBI_4", "RBIUsers4")
		.ageValidatorMin(rowNumC4, minDob, "RBI_4", "RBIUsers4")
		.ageValidatorAsOnDate(rowNumC4,dateAsOnDate2, "RBI_4", "RBIUsers4")
