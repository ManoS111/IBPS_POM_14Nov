...
public class TC002_RBIBasicDetails extends PreAndPost{	

	@BeforeTest
	public void setValues() {
		testCaseName = "TC002_RBIBasicDetails";
	...
	public void basicDetails(String Snum,String Desc,String Area,String Post,String Category,String PWD,String PWDTYPE,String Blindness,String HardOfHearing,
		...
		.rowNumC2()		
		.ageValidatorMax(rowNumC2, maxDob, "RBI_2", "RBIUSERS2")
		.ageValidatorMin(rowNumC2, minDob, "RBI_2", "RBIUSERS2")
		.ageValidatorAsOnDate(rowNumC2,dateAsOnDate2, "RBI_2", "RBIUSERS2")
